...
opt.dtd = msf_ensure_field(opt.dtd, 'dmin', 5e-12);
...
opt.dtd = msf_ensure_field(opt.dtd, 'n_out', 50); % 50
opt.dtd = msf_ensure_field(opt.dtd, 'n_kill', 0);
opt.dtd = msf_ensure_field(opt.dtd, 'n_proliferation', 20); % 10
opt.dtd = msf_ensure_field(opt.dtd, 'n_extinction', 20); % 10
